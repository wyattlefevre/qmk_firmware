...
[WINDOWS] = LAYOUT(
  ...
  LCTL_T(KC_ESC),   KC_A,  KC_S,  KC_D,  KC_F,  LT(NUM,KC_G),                    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,  KC_C,  KC_V,  KC_B,  KC_MPLY,                LGUI(KC_L),KC_N, KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
        MO(ARROWSPC), KC_LALT, KC_LGUI,LT(BRACK,KC_SPC), KC_LCTL,                LALT_T(KC_ENT), KC_SPC, KC_EQL, KC_BSLS, LGUI(KC_TAB)
),
...
[MAC] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,  KC_C,  KC_V,  KC_B,  KC_MPLY,                 LCTL(LGUI(KC_Q)),KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
        LCTL(KC_LALT),KC_LALT,MO(ARROWS),LT(BRACK,KC_SPC), KC_LGUI,                KC_ENT, KC_SPC, KC_EQL, RCTL_T(KC_BSLS), RCTL(KC_UP) 
),
[GAME] = LAYOUT(
...
[ARROWS] = LAYOUT(
  _______,_______,_______,_______,_______,_______,                    DF(MAC),DF(WINDOWS),DF(GAME),_______,KC_MPRV,KC_MNXT,
  ...
  _______,_______,_______,_______,_______,_______,KC_MPRV,    KC_MNXT,_______,_______,_______,_______,_______,_______,
              _______,_______,_______,KC_MPRV,KC_MNXT,            KC_RCTL,KC_RCTL,XXXXXXX,_______,_______
),
[ARROWSPC] = LAYOUT(
  _______,_______,_______,_______,_______,_______,                    DF(MAC),DF(WINDOWS),DF(GAME),_______,KC_MPRV,KC_MNXT,
  _______,_______,_______,_______,_______,_______,                    _______,_______,_______,_______,_______,_______,
  _______,_______,_______,_______,_______,_______,                    KC_LEFT,KC_DOWN,KC_UP, KC_RIGHT,_______,_______,
  _______,_______,_______,_______,_______,_______,KC_MPRV,    KC_MNXT,_______,_______,_______,_______,_______,_______,
              _______,_______,_______,KC_MPRV,KC_MNXT,            KC_RCTL,RCTL(KC_RGUI),XXXXXXX,_______,_______
),
// [4] = LAYOUT(
//   _______,_______,_______,_______,_______,_______,                    _______,_______,_______,_______,_______,_______,
//   _______,_______,_______,_______,_______,_______,                    _______,_______,_______,_______,_______,_______,
