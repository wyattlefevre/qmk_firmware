...
[MAC] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,  KC_C,  KC_V,  KC_B,  KC_MUTE,                 LCTL(LGUI(KC_Q)),KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
...
[GAME] = LAYOUT(
  XXXXXXX,   KC_1,  KC_2,  KC_3,  KC_4,  KC_5,                              KC_7,    KC_8,    KC_9,    KC_0,  KC_MINS, KC_GRV,
  ...
  KC_LSFT,   KC_LSFT,  KC_Z,  KC_X,  KC_C,  KC_V,  KC_MUTE,   LCTL(LGUI(KC_Q)),KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
        KC_LGUI, KC_LALT, KC_B,KC_SPC, KC_G,                  KC_ENT, KC_SPC, KC_EQL, RCTL_T(KC_BSLS),  DF(MAC) 
),
[NUM] = LAYOUT(
...
[ARROWS] = LAYOUT(
  ...
  _______,_______,_______,_______,_______,_______,_______,    _______,_______,_______,_______,_______,_______,_______,
              _______,_______,_______,_______,_______,            KC_RCTL,XXXXXXX,XXXXXXX,_______,_______
),
// [4] = LAYOUT(
//   _______,_______,_______,_______,_______,_______,                    _______,_______,_______,_______,_______,_______,
//   _______,_______,_______,_______,_______,_______,                    _______,_______,_______,_______,_______,_______,
